...
$adres_odbiorcy = 'nadzalewem1@interia.pl'; 	//tu wpisz adres e-mail na który mają przychodzić wiadomości
...
$valid['nick'] = 0 ; 	// Nick: 0 - oznacza pole nieobowiązkowe, inna liczba minimalną ilość znaków jakie musi wpisać użytkownik
...
$valid['tresc'] = 10 ; 	// Treść: 0 - oznacza pole nieobowiązkowe, inna liczba minimalną ilość znaków jakie musi wpisać użytkownik
...
$komunikat['tresc'] = 'Treść musi mieć min. 10 znaków'; 	//Wpisz właściwą ilość znaków jeśli pole wymagane
